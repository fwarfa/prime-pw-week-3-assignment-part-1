...
let favFoods = ['chicken', 'quesadilla', 'fries', 'steak sandwitch'];
...
favFoods.push('bagels');
console.log('Added another food faviorite of mine: ', favFoods);
